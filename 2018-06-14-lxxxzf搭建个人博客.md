...
　　本篇文章累计了大量评论，和我的一些解答，读者有什么问题可以先看看评论，或者搜下关键字，如果还是有问题可以给我在评论里给我留言，问题很着急的可以加我 ＱＱ：1499065178　，或者给我发邮件：[lxxxzf@icloud.com](mailto:lxxxzf@icloud.com)  ，都可以，如果你已经搭建完成了，可以看看我的另一篇博客[HEXO进阶](https://lxxxzf.github.io/)，有讲如何能百度搜索你的博客、多台电脑使用HEXO发布博客等。我现在的博客是使用 lxxxzf 搭建的，如果你想使用我现在的模板请看[lxxxzf搭建个人博客](https://github.com/lxxxzf/lxxxzf.github.io/blob/master/2018-06-14-lxxxzf%E6%90%AD%E5%BB%BA%E4%B8%AA%E4%BA%BA%E5%8D%9A%E5%AE%A2.md) 
...
翻到最下面，改成我这样子的，注意： `: 后面要有空格`
	...
	deploy:
	  type: git
	  repository: https://github.com/lxxxzf/lxxxzf.github.io
	  branch: master
...
　然后再浏览器中输入[https://lxxxzf.github.io/](https://lxxxzf.github.io/)就行了，我的 github 的账户叫 lxxxzf ,把这个改成你 github 的账户名就行了
...
转载请注明原地址，赖欣欣的博客：[https://lxx.github.ol](https://lxx.github.ol) 谢谢！
